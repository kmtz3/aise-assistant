...
- `--owner <name>` — run for a specific user's packages instead of your own (always confirms before proceeding when targeting someone else)
- `--apply` — skip the write approval gate and write directly
