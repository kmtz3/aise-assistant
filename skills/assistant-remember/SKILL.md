...
5. Write to **both** the project context file and cross-conversation memory (`~/.claude/projects/-Users-figg-Library-Mobile-Documents-com-apple-CloudDocs-Projects-agent-tools-meeting-assistant/memory/`).
