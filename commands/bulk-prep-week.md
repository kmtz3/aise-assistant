...
Read the procedure in [`agents/bulk-prep-week.md`](../agents/bulk-prep-week.md) and execute it inline as the main assistant — do not try to spawn `bulk-prep-week` as a subagent (custom agents in this plugin are procedure documents, not registered subagent types). The steps:
