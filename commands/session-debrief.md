...
argument-hint: <customer> [session-id]
---
...
4. Execute the customer follow-up email procedure documented in `agents/email-drafter.md` (read and run inline) — saved to Gmail Drafts, never sent.
